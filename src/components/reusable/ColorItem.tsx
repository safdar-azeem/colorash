...
const ColorItem = ({ color, radius }: ColorItemProps) => {
   ...
   return (
      <div
         ...
         <div
            className={`h-full w-full ${!isHover && ' invisible'} flex  justify-center items-center gap-2  `}>
            <ColorPicker
               value
               saturation
               color={colorValue}
            ...
            <Dropdown
               ...
               children={<ColorCodes colorCodes={colorCodes} setSelectedColorCode={setSelectedColorCode} />}
...
const ColorCodes = ({
   ...
   return (
      <ul className="dropdown-content menu bg-white rounded-lg p-2" style={{ width: 'max-content' }}>
