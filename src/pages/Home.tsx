         ...
         <AppContent className="grid lg:grid-cols-2 gap-24 container sm:text-left">
            <aside>
               ...
               <p className="text-fs-0 sm:text-fs-1 my-5 sm:my-8">
                  Create the perfect color palette for your next project with Colorash. Attract your audience
                  with a great color design combination and make your website stand out from the crowd.
                  Improve your workflow and save time with our color tools.
               </p>
                  ...
                  <ul className="flex flex-wrap gap-10  text-gray-600">
                     {appNavigation.map((item, index) => (
                        <li
                           ...
                           <NavLink to={item.path} className="whitespace-nowrap text-fs-0 ">
                              {item.label}
                           </NavLink>
                        </li>
                     ))}
